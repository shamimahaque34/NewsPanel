...
@section('title')
    Add Institute  Name Info
@endsection



@section('body-title-section')
    @include('backend.includes.body-page-title-two',['parent'=>'Institute  Name Info', 'child' =>'Add'])
@endsection
    ...
    <div class="row">
        <div class="col-md-12 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('institute-name-info.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
