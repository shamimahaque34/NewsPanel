...
@section('title')
    Add Version  Name Info
@endsection



@section('body-title-section')
    @include('backend.includes.body-page-title-two',['parent'=>'Version  Name Info', 'child' =>'Add'])
@endsection
    ...
    <div class="row">
        <div class="col-md-12 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('version-name-info.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                       ...
                       {{-- <div class="form-group row mt-2"> --}}
                                ...
                                <input type="text"  class="form-control" name="version_name" placeholder=" Enter Version  Name">
                            </div>
                       </div>
