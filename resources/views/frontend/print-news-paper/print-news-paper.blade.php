        ...
        <div class="col-lg-12">
			<div class="col-lg-12">
				<ul class="nav nav-pills nav-justified">
					<li class="nav-item">
					  <a class="nav-link " aria-current="page" href="{{route('/')}}">Tv</a>
					</li>
					<li class="nav-item">
					  <a class="nav-link active" href="{{route('print-news-paper')}}" id="">Print News Paper</a>
					</li>
					<li class="nav-item">
          ...
          <form action="{{route('print-news-paper-submit')}}" method="Post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              ...
              <div class="col-lg-6 " style="margin-bottom: 15px">
                <label for="sub_title" class="fw-bold text-muted fs-6">Sub Title</label>
                <input type="text" name="sub_title" id="sub_title" class="custom-input form-control shadow-none mt-2" placeholder="Enter Sub Title">
              </div>

              <div class="col-lg-6 " style="margin-bottom: 15px">
                <label for="caption" class="fw-bold text-muted fs-6">Caption</label>
                <input type="text" name="caption" id="caption" class="custom-input form-control shadow-none mt-2" placeholder="Enter Caption">
              </div>
              ...
              <div class="col-lg-6 " style="margin-bottom: 15px">
                <label for="bkash_no" class="fw-bold text-muted fs-6">Bkash No</label>
              ...
              <div class="col-lg-6" style="margin-bottom: 15px">
                <label for="image" class="fw-bold text-muted fs-6">
                  Image</label><br>
                <input type="file" name="image[]" multiple  id="image" class="custom-input form-control-file shadow-none mt-2" placeholder="">
              </div>

			  <div class="col-lg-12 " style="margin-bottom: 15px">
                <label for="" class="fw-bold text-muted fs-6">Main Description</label>
			  ...
			  <div class="col-lg-6 ">
                <label for="" class="fw-bold text-muted fs-6"> Print News paper Name
                  *</label>
				  ...
				  {{-- <div class="col-md-6">
					<label class="form-label">Institute Name</label> 
						  ...
						  <select class="form-control" name="institute_id" required id="instituteName" onclick="getversionNameByinstituteName(this.value)">
              ...
              <div class="col-lg-6 "style="margin-bottom: 15px">
                ...
                <input type="number" name="newspaper_count" id="selected" class=" form-control" value="0" placeholder="" readonly>
              </div>

             
              <div class="col-lg-6 ">
                <label for="" class="fw-bold text-muted fs-6"> Print News paper Price
                  </label>
              ...
              <div class="col-lg-6 ">
                <label for="" class="fw-bold text-muted fs-6"><!--  Print News paper Bkash Percentage -->
                  </label>
                  {{-- @foreach ($printNewsPaperPrices as $printNewsPaperPrice) --}}
                <div class="" style="margin-bottom: 15px">
                 
                  <input class="form-control mt-2 " type="hidden"  name="newspaper_bkash_percentage" value="18.5" id="newspaper_bkash_percentage">
                </div>
                {{-- @endforeach --}}
              </div>
 ...
 <script>
    $(document).ready(function(){
		$("#pageName").change(function(){
            ...
            method: "GET",
			type:'JSON',
            url:"{{url('/get-price-by-page-name')}}",
            data:{id:id},
