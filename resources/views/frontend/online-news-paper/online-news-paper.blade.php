      ...
      <div class="row">
		<div class="col-lg-12">
            <ul class="nav nav-pills nav-justified">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="{{route('online-news-paper')}}">Online News Paper</a>
                </li>
        ...
        <div class="col-lg-12">
          ...
          <form action="{{route('online-news-paper-submit')}}" method="Post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              ...
              <div class="col-lg-6 " style="margin-bottom: 15px">
                ...
                <input type="text" name="caption" id="caption" class="custom-input form-control shadow-none mt-2" id="editor" placeholder="Enter Caption">
              </div>
			  ...
			  <div class="col-lg-6 ">
                <label for="" class="fw-bold text-muted fs-6"> Online News paper Name
                  *</label>
...
{{-- 					
              ...
              <div class="col-lg-6 ">
                <label for="" class="fw-bold text-muted fs-6">Online News paper Price
                  </label>
              ...
              <div class="col-lg-6 ">
                <label for="" class="fw-bold text-muted fs-6"><!-- Online News paper Bkash Percentage -->
                  </label>
                  {{-- @foreach ($onlineNewsPaperPrices as $onlineNewsPaperPrice) --}}
                <div class="" style="margin-bottom: 15px">
