...
<head>
  ...
  <!-- Fontawesome CSS Link Starts Here-->
  <link rel="stylesheet" href="assets/css/vendor/all.min.css">
  <!-- Fontawesome CSS Link Ends Here-->

  <!-- Slick Slider CSS Link Starts Here-->
  <link rel="stylesheet" href="assets/css/vendor/slick.css">
  <link rel="stylesheet" href="assets/css/vendor/slick-theme.css">
  <!-- Slick Slider CSS Link Ends Here-->

  <!-- Magnific-Popup CSS Link Starts Here-->
  <link rel="stylesheet" href="assets/css/vendor/magnific-popup.css">
  <!-- Magnific-Popup CSS Link Ends Here-->
...
<section class="top-header about-header with-bottom-effect transparent-effect dark">
    ...
    <div class="header-container">	
        <div class="header-title wow fadeInUp"> 
            ...
            {{-- <div class="title">Career Apply Form</div> --}}
...
<section class="py-5">
        ...
        <div class="col-lg-12">
			...
			<div class="col-lg-12">
				<ul class="nav nav-pills nav-justified">
					<li class="nav-item">
					  <a class="nav-link active" aria-current="page" href="{{route('/')}}">Tv</a>
					</li>
					<li class="nav-item">
					  <a class="nav-link" href="{{route('print-news-paper')}}">Print News Paper</a>
					</li>
					<li class="nav-item">
					  <a class="nav-link" href="{{route('online-news-paper')}}">Online News Paper</a>
					</li>
          ...
          <form action="{{route('tv-submit')}}" method="Post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-lg-6" style="margin-bottom: 15px">
                <label for="title" class="fw-bold text-muted fs-6">Title</label>
                <input type="text" name="title" id="title" class="custom-input form-control shadow-none mt-2" placeholder="Enter Title">
              </div>

              <div class="col-lg-6 " style="margin-bottom: 15px">
                <label for="" class="fw-bold text-muted fs-6">File Name</label>
                <input type="text" name="file_name" id="main_description" class="custom-input form-control shadow-none mt-2" placeholder="Enter File Name">
              </div>

              <div class="col-lg-6" style="margin-bottom: 15px">
                <label for="" class="fw-bold text-muted fs-6">
                  Video Google Drive Link</label>
                <input type="text" name="video_google_drive_link"   id="" class="custom-input form-control shadow-none mt-2" placeholder=" Enter Google drive Link">
              </div>

              <div class="col-lg-6 " style="margin-bottom: 15px">
                <label for="reporter" class="fw-bold text-muted fs-6">Reporter Name</label>
                <input type="text" name="reporter" id="reporter" class="custom-input form-control shadow-none mt-2" placeholder="Enter Reporter Name">
              </div>

			  <div class="col-lg-12 " style="margin-bottom: 15px">
                <label for="" class="fw-bold text-muted fs-6">Description</label>
				<textarea  name="main_description"  class=" form-control"  cols="30" rows="2" id="editor" placeholder=""></textarea>

              </div>

              <div class="col-lg-6 " style="margin-bottom: 15px">
                <label for="bkash_no" class="fw-bold text-muted fs-6">Bkash Payment No</label><br>
                <input type="text" name="bkash_no" id="bkash_no" class="custom-input form-control shadow-none mt-2" placeholder="Enter Bkash No">
              </div>

			  <div class="col-lg-6 ">
                <label for="" class="fw-bold text-muted fs-6"> Tv Name
                  *</label>
                  {{-- @foreach ($printNewsPaperNames as $printNewsPaperName) --}}
				  ...
				  {{-- <div class="col-md-6">
					<label class="form-label">Institute Name</label> --}}
						...
						<input class="form-check-input checkbox " type="checkbox" class="education" name="tv_name[]" value="{{$instituteName->id}}" id="instituteNameTv">
              ...
              <div class="form-group row col-lg-12">
                ...
                <label for="divisions" class="fw-bold text-muted fs-6">Select Division</label>
              ...
              <!--/ Division Section-->
                ...
                <!--Districts Section-->
                <div class="col-lg-4 mb-2">
                <label for="distr" class="fw-bold text-muted ">Select District</label>
                <select name="districts" id="distr" value="" onchange="thanaList();"></select>
               </div>
                <!--/ Districts Section-->
                
                <!--Police Station Section-->
              <div class="col-lg-4 mb-2">
                <label for="polic_sta" class="fw-bold text-muted ">Select Police Station</label>
                <select name="police_station" id="polic_sta" value=""></select>
              </div>
              </div>


              <div class="col-lg-6 "style="margin-bottom: 15px">
                <label for="" class="fw-bold text-muted fs-6">Count</label>
                <input type="number" name="newspaper_count" id="selected" class=" form-control  mt-2" value="0" placeholder="" readonly>
              </div>

             
              <div class="col-lg-6 ">
                <label for="" class="fw-bold text-muted fs-6"> Tv Price
                  </label>
              ...
              <div class="col-lg-6 ">
                <label for="" class="fw-bold text-muted fs-6"><!-- Tv Bkash Percentage -->
                  </label>
                  {{-- @foreach ($tvPrices as $tvPrice) --}}
                <div class="" style="margin-bottom: 15px">
                 
                  <input class="form-control mt-2 " type="hidden"  name="newspaper_bkash_percentage" value="18.5" id="newspaper_bkash_percentage" readonly>
                </div>
                {{-- @endforeach --}}
              </div>
              ...
              {{-- <div class="col-lg-6 "style="margin-bottom: 15px">
                <label for="" class="fw-bold text-muted fs-6">Content Total Price Word</label>
			  ...
			  <div class="col-lg-6 " style="margin-bottom: 15px">
				...
				<input type="text" name="bkash_transaction_id" id="" class="custom-input form-control shadow-none mt-2" value="" placeholder="">
			 </div>
  ...
  <section>
    <div class="container">
      <div class="row">
         <div class="col-lg-12">
          <span class="text-muted">লাইম লাইট পি আর শুধুমাত্র এই  সংবাদটি সংশ্লিষ্ট গণমাধ্যমে পৌঁছানোর কাজটি করবে | সংবাদটি  প্রকাশের তারিখ ,প্রকাশের স্থান,আকার,রং,সংযোজন,বিয়োজন,কোন ক্ষেত্রেই লাইম লাইট পি আর দায়বদ্ধ নয় |সংবাদ প্রকাশের ক্ষেত্রে পত্রিকার নীতিমালা চূড়ান্ত বলে গণ্য হবে ।
          </span>
         </div>
      </div>
    </div>
...
{{-- <script>
    function getTotal()
            {  
              ...
              {
				document.getElementById('newspaper_price').value = 0 ;
...
{{-- <script>
	function getTotalMinus()
	{
		...
		var totalPaperPrice = 0;
		$('.total-price').each(function() {
			totalPaperPriceTV = Number(totalPaperPrice) + Number($(this).val()) ;
			totalPaperPriceTVMinus =   Number(totalPaperPriceTV) - Number($(this).val());
			 
		})
		
		$('#content_price').val(totalPaperPriceTVMinus);
