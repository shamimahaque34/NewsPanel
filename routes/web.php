...
Route::post('/print-news-paper-submit', [
    'uses' =>
        '\App\Http\Controllers\Front\PrintNewsPaperController@printNewsPaperSubmit',
...
Route::post('/online-news-paper-submit', [
    'uses' =>
        '\App\Http\Controllers\Front\OnlineNewsPaperController@onlineNewsPaperSubmit',
    'as' => 'online-news-paper-submit',
]);

Route::get('/get-price-by-institute-name', [
    'uses' =>
        'App\Http\Controllers\Front\OnlineNewsPaperController@getPriceByInstituteName',
    'as' => 'get-price-by-institute-name',
]);
...
Route::get('/get-price-by-institute-name-tv', [
    'uses' => 'App\Http\Controllers\Front\TvController@getPriceByInstituteName',
    'as' => 'get-price-by-institute-name-tv',
]);
...
Route::middleware(['auth:sanctum',config('jetstream.auth_session'),'verified', 'superAdmin',])->group(function () {
    ...
    Route::get('/manage-print-news-paper', [
        'uses' =>
            '\App\Http\Controllers\Admin\PrintNewsPaperController@managePrintNewsPaper',
        'as' => 'manage-print-news-paper',
    ]);

    Route::get('/update-print-news-paper-status/{id}', [
        'uses' =>
            'App\Http\Controllers\Admin\PrintNewsPaperController@updateStatus',
        'as' => 'print-news-paper.print-news-paper-status',
    ]);

    Route::get('/download/{fileName}', [
        'uses' =>
            'App\Http\Controllers\Admin\PrintNewsPaperController@download',
        'as' => 'download',
    ]);
    ...
    Route::delete('/delete-multiple-print-news-paper', [
        'uses' => '\App\Http\Controllers\Admin\PrintNewsPaperController@deleteMultiple',
        'as' => 'print-news-paper.delete-multiple-print-news-paper',
    ]);

    // Online News Paper Routes
    Route::get('/manage-online-news-paper', [
        'uses' =>
            '\App\Http\Controllers\Admin\OnlineNewsPaperController@manageOnlineNewsPaper',
    ...
    Route::delete('/delete-multiple-online-news-paper', [
        'uses' => '\App\Http\Controllers\Admin\OnlineNewsPaperController@deleteMultiple',
        'as' => 'online-news-paper.delete-multiple-online-news-paper',
    ]);

    Route::get('/update-online-news-paper-status/{id}', [
        'uses' =>
            'App\Http\Controllers\Admin\OnlineNewsPaperController@updateStatus',
        'as' => 'online-news-paper.online-news-paper-status',
    ]);

    Route::get('/download/{fileName}', [
        'uses' =>
            'App\Http\Controllers\Admin\OnlinetNewsPaperController@download',
        'as' => 'download',
    ]);
    ...
    Route::delete('/delete-multiple-tv', [
        'uses' => '\App\Http\Controllers\Admin\TvController@deleteMultiple',
        'as' => 'tv.delete-multiple-tv',
    ]);
    ...
    Route::delete('/delete-multiple-institute-type-name-info', [
        'uses' => '\App\Http\Controllers\Admin\InstituteTypeController@deleteMultiple',
        'as' => 'institute-type-name-info.delete-multiple-institute-type-name-info',
    ]);
    ...
    Route::delete('/delete-multiple-institute-name-info', [
        'uses' => '\App\Http\Controllers\Admin\InstituteNameController@deleteMultiple',
        'as' => 'institute-name-info.delete-multiple-institute-name-info',
    ]);
    ...
    Route::get('/get-institute-name-by-institute-type', [
        'uses' =>
            'App\Http\Controllers\Admin\VersionNameController@getInstituteNameByInstituteType',
        'as' => 'get-institute-name-by-institute-type',
    ]);

    Route::delete('/delete-multiple-version-name-info', [
        'uses' => '\App\Http\Controllers\Admin\VersionNameController@deleteMultiple',
        'as' => 'version-name-info.delete-multiple-version-name-info',
    ]);
    ...
    Route::delete('/delete-multiple-page-name-info', [
        'uses' => '\App\Http\Controllers\Admin\PageNameController@deleteMultiple',
        'as' => 'version-name-info.delete-multiple-page-name-info',
    ]);

    Route::get('/get-institute-name-by-institute-type', [
        'uses' =>
            'App\Http\Controllers\Admin\PageNameController@getInstituteNameByInstituteType',
        'as' => 'get-version-name-by-institute-name',
    ]);
    ...
    Route::delete('/delete-multiple-price-info', [
        'uses' => '\App\Http\Controllers\Admin\PriceController@deleteMultiple',
        'as' => 'price-info.delete-multiple-price-info',
    ]);

    Route::get('/get-institute-name-by-institute-type', [
        'uses' =>
            'App\Http\Controllers\Admin\PriceController@getInstituteNameByInstituteType',
        'as' => 'get-version-name-by-institute-name',
    ]);

    Route::get('/get-version-name-by-institute-name', [
        'uses' =>
            'App\Http\Controllers\Admin\PriceController@getVersionNameByInstituteName',
        'as' => 'get-version-name-by-institute-name',
    ]);

    Route::get('/get-page-name-by-version-name', [
        'uses' =>
            'App\Http\Controllers\Admin\PriceController@getPageNameByVersionName',
        'as' => 'get-page-name-by-version-name',
    ]);
});
...
Route::get('/get-version-name-by-institute-name', [
    'uses' =>
        'App\Http\Controllers\Admin\PageNameController@getVersionNameByInstituteName',
    'as' => 'get-version-name-by-institute-name',
]);

Route::get('/get-page-name-by-version-name', [
    'uses' =>
        'App\Http\Controllers\Front\PrintNewsPaperController@getPageNameByVersionName',
    'as' => 'get-page-name-by-version-name',
]);

Route::get('/get-price-by-page-name', [
    'uses' =>
        'App\Http\Controllers\Front\PrintNewsPaperController@getPriceByPageName',
    'as' => 'get-price-by-page-name',
]);
