    ...
    for(var i=0; i<checkboxes.length; i++)
    {
        checkboxes[i].addEventListener('click',function(){
            if(this.checked == true)
            {
             ...
             document.getElementById('selected').value = count;
        ...
        //      document.getElementById('content_price').value = Number.parseInt( totalPrice) + 1 ;
        ...
        //     //  document.getElementById('content_price_word').value = zero;
        //    }

           numText = '';        
        
           //get the value of the number the user submits
           var num = document.getElementById('content_price').value;
          //  alert(num);
           ...
           document.getElementById('content_price_word').value= finalNumText;
