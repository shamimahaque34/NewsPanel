    ...
    public static function onlineNewsPaperSubmit($request)
    {
        ...
        if (self::$files = $request->file('image')) {
            foreach (self::$files as self::$file) {
                ...
                self::$directory =
                    './backend/assets/image/OnlineNewsPaperImages/';
        ...
        self::$onlineNewsPaper->newspaper_name = json_encode(
        ...
        self::$onlineNewsPaper->newspaper_bkash_percentage =
            $request->newspaper_bkash_percentage;
        self::$onlineNewsPaper->content_price = $request->content_price;
        self::$onlineNewsPaper->content_price_word =
            $request->content_price_word;
        self::$onlineNewsPaper->bkash_transaction_id =
