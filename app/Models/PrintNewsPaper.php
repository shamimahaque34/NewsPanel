...
class PrintNewsPaper extends Model
{
     ...
     public static function printNewsPaperSubmit( $request)
    {
        ...
        self::$printNewsPaper->newspaper_name             = json_encode($request->newspaper_name);
        ...
        self::$printNewsPaper->newspaper_bkash_percentage = $request->newspaper_bkash_percentage;
        self::$printNewsPaper->content_price              = $request->content_price;
        self::$printNewsPaper->content_price_word         = $request->content_price_word;
